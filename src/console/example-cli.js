...
import { loadavg, cpus, freemem, uptime } from "os";
...
// import { list, decompress } from "./logs";
...
//     cli.verticalSpace();
//     // Decompress it
//     decompress(logFileName, function (err, strData) {
//       if (!err && strData) {
//         // Split it into lines
//         var arr = strData.split("\n");
//         arr.forEach(function (jsonString) {
//           var logObject = parseJsonToObject(jsonString);
...
cli.responders.createCrud = function (str) {
  template_file = join(__dirname, "/../lib/handlers/crudTemplates.js");
  handlers_dir = join(__dirname, "/../lib/handlers");
  router_dir = join(__dirname, "/../lib/routers.js");
  ...
  "${fileName}": ${fileName}.${fileName},`,
                ...
                writeFile(router_dir, newRouter, function (err) {
                  if (err) {
...
cli.init = function () {
  ...
  // Start the interface
  var _interface = createInterface({
    input: process.stdin,
